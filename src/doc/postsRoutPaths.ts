const postPaths = {
    "/post/create": {
      post: {
        ...
        description: "Allows a host to create a new post with an optional photo upload.",
        tags: ["Posts"],
        security: [{ bearerAuth: [] }],
        requestBody: {
          required: true,
          content: {
            "multipart/form-data": {
              schema: {
                ...
                required: ["date", "time", "minimumWaveHeight", "maximumWaveHeight", "averageWindSpeed", "description"],
              },
            },
          },
        },
